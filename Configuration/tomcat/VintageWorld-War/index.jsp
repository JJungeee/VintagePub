        ...
        <div class="record_svg_wrap bg-full">
            <svg width="100%" height="100%">
                <mask id="record_mask">
                    ...
                    <image class="record_svg" xlink:href="img/main/record_white.png" x="50%" y="50%" width="400" height="400"></image>
                </mask>
                <image mask="url(#record_mask)" xlink:href="img/common/vin2.png" x="0" y="0" width="100%" height="100%"></image>
            </svg>
        </div>
    </section>
    <!-- //record end -->

...
<jsp:include page="../inc/top.jsp"/>
    ...
    <section class="shop rel over_h">
        ...
        <div class="shop_record bg-full bg-cover"></div>
<!--         <div class="svg_figure bg-full"> -->
<!--             <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%"> -->
<!--                 <mask id="svg_mask"> -->
<!--                     <rect x="0" y="0" width="500px" height="500px" fill="#fff"></rect> -->
<!--                     <image id="shop_record" x="50%" y="50%" href="../img/main/record.png"></image> -->
<!--                 </mask> -->
